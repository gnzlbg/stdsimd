...
pub unsafe extern "ptx-kernel" fn rgba2gray(rgba: *const Rgba,
                                            ...
                                            width: i32,
                                            height: i32) {
    let x = nvptx::block_idx_x()
        .wrapping_mul(nvptx::block_dim_x())
        .wrapping_add(nvptx::thread_idx_x());
    let y = nvptx::block_idx_y()
        .wrapping_mul(nvptx::block_dim_y())
        .wrapping_add(nvptx::thread_idx_y());
